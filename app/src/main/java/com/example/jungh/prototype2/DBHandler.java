...
public class DBHandler {
    ...
    public void copyDB() {
        ...
        try {
            ...
            File file = new File("/data/data/com.example.jungh.prototype2/files/");
            file.mkdir();
            fos = new FileOutputStream("/data/data/com.example.jungh.prototype2/files/DBpath.txt");
            ...
            fr = new FileReader("/data/data/com.example.jungh.prototype2/files/DBpath.txt");
            ...
            file = new File("/data/data/com.example.jungh.prototype2/databases/");
            file.mkdir();
            fos = new FileOutputStream("/data/data/com.example.jungh.prototype2/databases/" + mNewestDBInfo);
    ...
    public void readDB() {
        ...
        // 읽어들인 경로로 .db 파일 열기
        SQLiteDatabase sqlDB = SQLiteDatabase.openDatabase("/data/data/com.example.jungh.prototype2/databases/"+mNewestDBInfo, null, SQLiteDatabase.NO_LOCALIZED_COLLATORS);
